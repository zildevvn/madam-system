...
const TableList = ({ 
    ...
    const getTableStatus = (tableId) => {
        ...
        const diff = Math.floor((currentTime - new Date(order.startTime)) / 60000);
    ...
    return (
        <div className={`flex flex-col overflow-hidden h-full ${className}`}>
            ...
            <div className="p-4 md:px-2 overflow-y-auto flex-1 hide-scrollbar">
                <div className="list-tables grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 md:gap-4">
                        ...
                        return (
                            ...
                            >
                                <span className={`text-lg font-black ${!statusClass ? 'text-gray-900' : ''}`}>
                                    {tables.length > 20 ? table.id : idx + 1}
                                </span>
