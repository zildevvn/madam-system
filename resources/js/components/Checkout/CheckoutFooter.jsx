                    ...
                    {isSplitMode ? (
                        <>
                            ...
                            <button
                                ...
                                disabled={splitItemsCount === 0 || isSaving}
                                className={`btn-save mdt-btn w-full text-xs transition-all ${splitItemsCount === 0 || isSaving ? 'opacity-50 grayscale cursor-not-allowed' : ''}`}
                            >
                                {isSaving ? (
