...
export default function Header() {
    ...
    const navigation = [
        { name: 'Home', href: '/' },
        { name: 'Tables Dashboard', href: '/tables' }
    ];
        ...
        <header className="bg-white shadow">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 justify-between items-center">
                    ...
                    <div class="flex">
                        <div class="header-main__humberger">
                            <button type="button" class="header-main__humberger__btn">
                                <span></span>
                                <span></span>
                                <span></span>
                            </button>
