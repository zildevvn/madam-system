    ...
    return (
        <div className="p-8 lg:p-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                {/* Total Orders */}
                <div className="bg-[#eff6ff] p-8 lg:p-10 rounded-[12px] border border-blue-50/50 flex flex-col justify-between min-h-[180px] group hover:bg-[#dbeafe] transition-all">
                    <div className="flex justify-between items-start mb-6">
                        <span className="text-[11px] font-black text-blue-600 uppercase tracking-widest">Tổng đơn</span>
                    ...
                    <div className="text-[54px] font-black text-slate-900 tracking-tight leading-none">{stats?.total_orders || 0}</div>
                </div>

                {/* Individual Orders */}
                <div className="bg-[#eff6ff] p-8 lg:p-10 rounded-[12px] border border-blue-50/50 flex flex-col justify-between min-h-[180px] group hover:bg-[#dbeafe] transition-all">
                    <div className="flex justify-between items-start mb-6">
                        <span className="text-[11px] font-black text-blue-600 uppercase tracking-widest">Khách lẻ</span>
                        <div className="p-3 bg-white text-blue-600 rounded-full shadow-sm group-hover:scale-110 transition-transform">
                    ...
                    <div className="text-[54px] font-black text-slate-900 tracking-tight leading-none">{stats?.individual_orders || 0}</div>
                </div>

                {/* Group Orders */}
                <div className="bg-[#eff6ff] p-8 lg:p-10 rounded-[12px] border border-blue-50/50 flex flex-col justify-between min-h-[180px] group hover:bg-[#dbeafe] transition-all">
                    <div className="flex justify-between items-start mb-6">
                        <span className="text-[11px] font-black text-blue-600 uppercase tracking-widest">Khách đoàn</span>
                        <div className="p-3 bg-white text-blue-600 rounded-full shadow-sm group-hover:scale-110 transition-transform">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                        </div>
                    </div>
                    <div className="text-[54px] font-black text-slate-900 tracking-tight leading-none">{stats?.group_orders || 0}</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    <div key={idx} className="bg-[#f0f9ff] p-5 rounded-[12px] border border-blue-50/50 flex flex-col gap-3 group hover:bg-[#e0f2fe] transition-all">
                        ...
                        <div className="text-[22px] font-black text-slate-900">{formatPrice(item.val || 0)}đ</div>
                    </div>
                ))}
            </div>
        </div>
