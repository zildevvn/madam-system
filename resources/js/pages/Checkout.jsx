...
export default function Checkout() {
    ...
    // Demo data for now
    const selectedItems = [
        { id: 1, name: "Bún bò Huế Đặc biệt Bún bò Huế Đặc biệt Bún bò Huế Đặc biệt Bún bò Huế Đặc biệt", price: 65000, quantity: 2, image: "" },
        { id: 2, name: "Trà đào cam sả", price: 35000, quantity: 1, image: "" },
        { id: 3, name: "Nem lụi (vỉ 5 cái)", price: 85000, quantity: 1, image: "" }
    ];
    ...
    return (
        <div className="mdt-bg-light mdt-checkout-page min-h-screen pb-40">
            ...
            <main className="px-2 pt-4 max-w-2xl mx-auto space-y-4">
                {/* Food Items List */}
                <div className="list-products bg-white rounded-md shadow-sm py-5">
                    {selectedItems.map((item) => (
                        <div key={item.id} className="product-item bg-surface-container-lowest px-2 py-0 rounded-lg flex flex-col gap-2">
                            ...
                            <div className="flex items-center justify-end gap-2">
                                <div className="flex items-center bg-gray-100 rounded-full p-1 border border-outline-variant/10 shadow-sm">
                                    <button className="w-6 h-6 flex items-center justify-center rounded-full bg-white text-on-surface border-none  active:scale-90 transition-all hover:bg-white/80">
                                    ...
                                    <button className="btn-plus w-6 h-6 flex items-center justify-center rounded-full text-white shadow-md active:scale-90 transition-all hover:brightness-110">
            ...
            <footer className="fixed bottom-0 left-0 w-full px-2 py-4 bg-white/85 bg-white z-50 rounded-t-2xl shadow-[0_-4px_40px_rgba(49,50,52,0.06)]">
                <div className="max-w-2xl mx-auto">
                    <div className="flex justify-between items-end mb-4">
                        <span className="font-extrabol label-md text-on-surface-variant uppercase tracking-wider">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <button
                            ...
                            className="btn-add flex-1 flex flex-row items-center justify-center text-[#313234] dark:text-slate-300 border border-[#b2b2b4]/20 rounded-xl px-4 py-3 gap-2 active:scale-98 duration-150 hover:opacity-90"
                        >
                        ...
                        <button
                            ...
                            className="btn-save flex-[1.5] flex items-center justify-center text-white rounded-xl px-4 py-3 gap-2 active:scale-98 duration-150 shadow-lg shadow-primary/20"
                        >
