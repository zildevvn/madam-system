...
const ReservationCreate = () => {
    ...
    const inputClasses = "w-full bg-gray-200 border border-gray-100 rounded-xl px-3 py-3 text-[14px] focus:border-orange-200 outline-none transition-all";
        ...
        <div className="max-w-3xl mx-auto p-2 md:p-4 bg-white rounded-[16px] shadow-sm border border-gray-100 mt-4 mb-10 overflow-hidden text-gray-800">
            ...
            <form onSubmit={onSubmit} className="relative space-y-4">
                ...
                <div className="bg-gray-50/50 p-3 rounded-[16px] border border-gray-100/50">
                    ...
                    <textarea {...register('note')} rows="15" className={`${inputClasses} resize-none`} />
                </div>
